...
if __name__ == '__main__':
    ...
    URL = "https://www.amazon.com/Fresh-Fruits/b?ie=UTF8&node=16318981"
    ...
    d = {"title": [], "total price": [], "price per unit": [], "unit": [], "link": [], "availability": []}

    for page in range(1, 27):  # Looping through all 26 pages
            print(f"Scraping page {page}")
            URL = f"https://www.amazon.com/s?k=Fresh+Fruits&i=grocery&rh=n%3A16318981&page={page}&c=ts&qid=1731997546&ts_id=16318981&ref=sr_pg_{page}"
            webpage = requests.get(URL, headers=HEADERS)
            soup = BeautifulSoup(webpage.content, "html.parser")
            ...
            for link in links_list:
                if link.startswith("/"):
                    new_webpage = requests.get(f"https://amazon.com{link}", headers=HEADERS)
                else:
    ...
    print("Scraping completed and data saved to amazon_products1.csv")
